...
/**
 * This class defines the structure of the 'signups' table.
 *
 *
 *
 ...
 *
 */
class SignupsTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.SignupsTableMap';
     ...
     */
    const OM_CLASS = '\\Signups';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Signups';
  ...
  array (
    ...
    {
        return $withPrefix ? SignupsTableMap::CLASS_DEFAULT : SignupsTableMap::OM_CLASS;
    }
     ...
     * @return array           (Signups object, last column rank)
     */
    public static function populateObject($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        $key = SignupsTableMap::getPrimaryKeyHashFromRow($row, $offset, $indexType);
        if (null !== ($obj = SignupsTableMap::getInstanceFromPool($key))) {
            // We no longer rehydrate the object, since this can cause data loss.
            // See http://www.propelorm.org/ticket/509
            // $obj->hydrate($row, $offset, true); // rehydrate
            $col = $offset + SignupsTableMap::NUM_HYDRATE_COLUMNS;
        } else {
            $cls = SignupsTableMap::OM_CLASS;
            /** @var Signups $obj */
            $obj = new $cls();
            $col = $obj->hydrate($row, $offset, false, $indexType);
            SignupsTableMap::addInstanceToPool($obj, $key);
        }
    ...
    public static function populateObjects(DataFetcherInterface $dataFetcher)
    {
        ...
        while ($row = $dataFetcher->fetch()) {
            $key = SignupsTableMap::getPrimaryKeyHashFromRow($row, 0, $dataFetcher->getIndexType());
            if (null !== ($obj = SignupsTableMap::getInstanceFromPool($key))) {
                // We no longer rehydrate the object, since this can cause data loss.
                // See http://www.propelorm.org/ticket/509
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(SignupsTableMap::COL_USER);
            $criteria->addSelectColumn(SignupsTableMap::COL_SHIFT);
            $criteria->addSelectColumn(SignupsTableMap::COL_EVENT);
            $criteria->addSelectColumn(SignupsTableMap::COL_DRIVER);
    ...
    {
        return Propel::getServiceContainer()->getDatabaseMap(SignupsTableMap::DATABASE_NAME)->getTable(SignupsTableMap::TABLE_NAME);
    }
    ...
    {
        $dbMap = Propel::getServiceContainer()->getDatabaseMap(SignupsTableMap::DATABASE_NAME);
        if (!$dbMap->hasTable(SignupsTableMap::TABLE_NAME)) {
            $dbMap->addTableObject(new SignupsTableMap());
        }
    }

    /**
     * Performs a DELETE on the database, given a Signups or Criteria object OR a primary key value.
     *
     * @param mixed               $values Criteria or Signups object or primary key or array of primary keys
     ...
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            foreach ((array) $values as $singleval) {
                SignupsTableMap::removeInstanceFromPool($singleval);
            }
        }
    ...
    {
        return SignupsQuery::create()->doDeleteAll($con);
    }

    /**
     * Performs an INSERT on the database, given a Signups or Criteria object.
     *
     * @param mixed               $criteria Criteria or Signups object containing data that is used to create the INSERT statement.
