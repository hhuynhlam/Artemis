...
class MembersTableMap extends TableMap
{
     ...
     */
    const COL_PROVIDER = 'members.provider';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'FirstName', 'MiddleName', 'LastName', 'Position', 'MailList', 'Email', 'Aim', 'Website', 'Phone', 'PermAddress', 'TempAddress', 'Avatar', 'Signature', 'Class', 'Username', 'Password', 'Family', 'Birthday', 'ShirtSize', 'TotalService', 'TotalFellowship', 'Notes', 'FeesOwed', 'EmailList', 'Reminder', 'FirstTime', 'Provider', ),
        self::TYPE_CAMELNAME     => array('id', 'firstName', 'middleName', 'lastName', 'position', 'mailList', 'email', 'aim', 'website', 'phone', 'permAddress', 'tempAddress', 'avatar', 'signature', 'class', 'username', 'password', 'family', 'birthday', 'shirtSize', 'totalService', 'totalFellowship', 'notes', 'feesOwed', 'emailList', 'reminder', 'firstTime', 'provider', ),
        self::TYPE_COLNAME       => array(MembersTableMap::COL_ID, MembersTableMap::COL_FIRST_NAME, MembersTableMap::COL_MIDDLE_NAME, MembersTableMap::COL_LAST_NAME, MembersTableMap::COL_POSITION, MembersTableMap::COL_MAIL_LIST, MembersTableMap::COL_EMAIL, MembersTableMap::COL_AIM, MembersTableMap::COL_WEBSITE, MembersTableMap::COL_PHONE, MembersTableMap::COL_PERM_ADDRESS, MembersTableMap::COL_TEMP_ADDRESS, MembersTableMap::COL_AVATAR, MembersTableMap::COL_SIGNATURE, MembersTableMap::COL_CLASS, MembersTableMap::COL_USERNAME, MembersTableMap::COL_PASSWORD, MembersTableMap::COL_FAMILY, MembersTableMap::COL_BIRTHDAY, MembersTableMap::COL_SHIRT_SIZE, MembersTableMap::COL_TOTAL_SERVICE, MembersTableMap::COL_TOTAL_FELLOWSHIP, MembersTableMap::COL_NOTES, MembersTableMap::COL_FEES_OWED, MembersTableMap::COL_EMAIL_LIST, MembersTableMap::COL_REMINDER, MembersTableMap::COL_FIRST_TIME, MembersTableMap::COL_PROVIDER, ),
        self::TYPE_FIELDNAME     => array('id', 'first_name', 'middle_name', 'last_name', 'position', 'mail_list', 'email', 'aim', 'website', 'phone', 'perm_address', 'temp_address', 'avatar', 'signature', 'class', 'username', 'password', 'family', 'birthday', 'shirt_size', 'total_service', 'total_fellowship', 'notes', 'fees_owed', 'email_list', 'reminder', 'first_time', 'provider', ),
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(MembersTableMap::COL_PROVIDER);
        } else {
