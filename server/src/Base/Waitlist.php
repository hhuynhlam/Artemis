...
*/
abstract class Waitlist implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\WaitlistTableMap';
    ...
    /**
     * Initializes internal state of Base\Waitlist object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>Waitlist</code> instance.  If
     * <code>obj</code> is an instance of <code>Waitlist</code>, delegates to
     * <code>equals(Waitlist)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Waitlist The current object, for fluid interface
     */
    ...
    public function setShift($v)
    {
        ...
        if ($this->shift !== $v) {
            $this->shift = $v;
            $this->modifiedColumns[WaitlistTableMap::COL_SHIFT] = true;
        }
    ...
    public function setEvent($v)
    {
        ...
        if ($this->event !== $v) {
            $this->event = $v;
            $this->modifiedColumns[WaitlistTableMap::COL_EVENT] = true;
        }
    ...
    public function setTimestamp($v)
    {
        ...
        if ($this->timestamp !== $v) {
            $this->timestamp = $v;
            $this->modifiedColumns[WaitlistTableMap::COL_TIMESTAMP] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : WaitlistTableMap::translateFieldName('User', TableMap::TYPE_PHPNAME, $indexType)];
            $this->user = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : WaitlistTableMap::translateFieldName('Shift', TableMap::TYPE_PHPNAME, $indexType)];
            $this->shift = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : WaitlistTableMap::translateFieldName('Event', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildWaitlistQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Waitlist::setDeleted()
     * @see Waitlist::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildWaitlistQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                WaitlistTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    {
        $pos = WaitlistTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $alreadyDumpedObjects['Waitlist'][$this->hashCode()] = true;
        $keys = WaitlistTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getUser(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(WaitlistTableMap::COL_USER)) {
            $criteria->add(WaitlistTableMap::COL_USER, $this->user);
        }
        if ($this->isColumnModified(WaitlistTableMap::COL_SHIFT)) {
            $criteria->add(WaitlistTableMap::COL_SHIFT, $this->shift);
        }
        if ($this->isColumnModified(WaitlistTableMap::COL_EVENT)) {
            $criteria->add(WaitlistTableMap::COL_EVENT, $this->event);
        }
        if ($this->isColumnModified(WaitlistTableMap::COL_TIMESTAMP)) {
    ...
    public function getEvents(ConnectionInterface $con = null)
    {
        if ($this->aEvents === null && ($this->event !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aEvents->addWaitlists($this);
             */
        }
    ...
    public function getShifts(ConnectionInterface $con = null)
    {
        if ($this->aShifts === null && ($this->shift !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aShifts->addWaitlists($this);
             */
        }
    ...
    public function clear()
    {
        ...
        if (null !== $this->aEvents) {
            $this->aEvents->removeWaitlist($this);
        }
        if (null !== $this->aShifts) {
            $this->aShifts->removeWaitlist($this);
        }
        $this->user = null;
        $this->shift = null;
        $this->event = null;
    ...
    {
        return (string) $this->exportTo(WaitlistTableMap::DEFAULT_STRING_FORMAT);
    }
