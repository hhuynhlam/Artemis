 ...
 *
 * @method     ChildEventsQuery leftJoinSignups($relationAlias = null) Adds a LEFT JOIN clause to the query using the Signups relation
 * @method     ChildEventsQuery rightJoinSignups($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Signups relation
 * @method     ChildEventsQuery innerJoinSignups($relationAlias = null) Adds a INNER JOIN clause to the query using the Signups relation
 *
 * @method     ChildEventsQuery leftJoinWaitlist($relationAlias = null) Adds a LEFT JOIN clause to the query using the Waitlist relation
 * @method     ChildEventsQuery rightJoinWaitlist($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Waitlist relation
 * @method     ChildEventsQuery innerJoinWaitlist($relationAlias = null) Adds a INNER JOIN clause to the query using the Waitlist relation
 *
...
abstract class EventsQuery extends ModelCriteria
{
    ...
    public function filterBySignups($signups, $comparison = null)
    {
        if ($signups instanceof \Signups) {
            return $this
                ->addUsingAlias(EventsTableMap::COL_ID, $signups->getEvent(), $comparison);
    ...
    public function filterByWaitlist($waitlist, $comparison = null)
    {
        if ($waitlist instanceof \Waitlist) {
            return $this
                ->addUsingAlias(EventsTableMap::COL_ID, $waitlist->getEvent(), $comparison);
