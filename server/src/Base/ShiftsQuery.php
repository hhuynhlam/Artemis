 ...
 *
 * @method     ChildShiftsQuery leftJoinWaitlist($relationAlias = null) Adds a LEFT JOIN clause to the query using the Waitlist relation
 * @method     ChildShiftsQuery rightJoinWaitlist($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Waitlist relation
 * @method     ChildShiftsQuery innerJoinWaitlist($relationAlias = null) Adds a INNER JOIN clause to the query using the Waitlist relation
 *
...
abstract class ShiftsQuery extends ModelCriteria
{
    ...
    public function filterByWaitlist($waitlist, $comparison = null)
    {
        if ($waitlist instanceof \Waitlist) {
            return $this
                ->addUsingAlias(ShiftsTableMap::COL_ID, $waitlist->getShift(), $comparison);
